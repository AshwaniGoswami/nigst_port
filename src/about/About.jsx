...
const About = () => {
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8 m-8 '>
            ...
            <div className=' bg-[#f5eeee76] p-6 rounded-md leading-normal md:col-span-2 '>
                ...
                {isEnglish ? (
                    ...
                    <div className='hindi leading-relaxed text-justify p-6 md:p-12 lg:p-14'>
    ...
    <img src={require('../assests/Home Banner NIGST.png')} alt="img2" className='w-auto h-[250px] object-cover rounded-md'  />
</div>
