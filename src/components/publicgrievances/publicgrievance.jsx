        ...
        <div class="content-container">
            ...
            <div class="rti-container">
                <div class="hindi-rti">
                    ...
                    <ul>
                        <li> लोक शिकायत अधिकारी</li>
                        <li>श्री. वरून कुमार</li>
                        <li> उप महासर्वेक्षक</li>
                ...
                <div class="english-rti">
                    ...
                    <ul>
                        <li>PUBLIC GRIEVANCE OFFICER</li>
                        <li> SHRI G. VARUNA KUMAR</li>
                        <li> DEPUTY SURVEYOR GENERAL</li>
