...
function Tendertable() {
  ...
  useEffect(() => {
    fetch('http://nigstserver-env-4.eba-upjrs3n3.ap-south-1.elasticbeanstalk.com/tender/view')
  ...
  useEffect(() => {
    fetch('http://nigstserver-env-4.eba-upjrs3n3.ap-south-1.elasticbeanstalk.com/tender/view_archive')
      .then(response => response.json())
